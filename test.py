...
if __name__ == '__main__':
    ...
    path = './saved_model/{}.pth'.format(str(52) + '_' + str(n_agent))
    policy.load_state_dict(torch.load(path, map_location=torch.device(dev)))

    testing_data = torch.load('./validation_data/validation_data_' + str(52) + '_' + str(batch_size))
    results_per_seed = []
    for seed in seeds:
        print('Size:', 52, 'Seed:', seed)
    ...
    print('Size:', 52, results_per_seed)
